...
public class RiddleToFunctionMapper {
    ...
    public static at.escapedoom.player.rest.model.RiddleDTO riddleToFrontendFunction( at.escapedoom.spring.communication.data.model.RiddleDTO riddle) {

        assert riddle.getLanguage() != null;

        at.escapedoom.player.rest.model.RiddleDTO.RiddleDTOBuilder builder = at.escapedoom.player.rest.model.RiddleDTO.builder();
