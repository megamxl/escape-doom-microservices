...
public class SessionResponse {
    ...
    public SessionResponse state(EscapeRoomState state) {
        this.state = state;
        return this;
    }
    ...
    public SessionResponse templateId(UUID templateId) {
    ...
    public SessionResponse tags(List<String> tags) {
        this.tags = tags;
        return this;
    }

    public SessionResponse addTagsItem(String tagsItem) {
        if (this.tags == null) {
