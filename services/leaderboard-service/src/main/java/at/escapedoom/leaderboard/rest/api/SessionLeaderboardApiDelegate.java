...
/**
 * A delegate to be called by the {@link SessionLeaderboardApiController}}.
...
public interface SessionLeaderboardApiDelegate {
     ...
     */
    default ResponseEntity<List<FullExportRoomPinGet200ResponseInner>> fullExportRoomPinGet(Integer roomPin) {
    ...
    default ResponseEntity<List<UserProgress>> roomPinGet(Integer roomPin) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "[ { \"score\" : 30, \"last_riddle_solved_at\" : \"2025-01-02T15:45:00Z\", \"current_escape_room_level\" : 5, \"player_name\" : \"Waschbär\", \"results\" : [ { \"input\" : \"Solution Attempt\", \"added_points\" : 100, \"current_escape_room_level\" : 3, \"solved_date\" : \"2025-01-02T15:45:00Z\" }, { \"input\" : \"Solution Attempt\", \"added_points\" : 100, \"current_escape_room_level\" : 3, \"solved_date\" : \"2025-01-02T15:45:00Z\" } ], \"escape_room_session_id\" : \"a32d8f8c-f2f4-4c4d-b9c3-e5a7d7f6e8f0\" }, { \"score\" : 30, \"last_riddle_solved_at\" : \"2025-01-02T15:45:00Z\", \"current_escape_room_level\" : 5, \"player_name\" : \"Waschbär\", \"results\" : [ { \"input\" : \"Solution Attempt\", \"added_points\" : 100, \"current_escape_room_level\" : 3, \"solved_date\" : \"2025-01-02T15:45:00Z\" }, { \"input\" : \"Solution Attempt\", \"added_points\" : 100, \"current_escape_room_level\" : 3, \"solved_date\" : \"2025-01-02T15:45:00Z\" } ], \"escape_room_session_id\" : \"a32d8f8c-f2f4-4c4d-b9c3-e5a7d7f6e8f0\" } ]";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
