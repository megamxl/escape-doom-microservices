...
/**
 * A delegate to be called by the {@link AllLeaderboardsApiController}}. Implement this interface with a
...
public interface AllLeaderboardsApiDelegate {
     ...
     *
     * @param tag
     *            A tags to filter sessions. (optional)
     *
     ...
     */
    default ResponseEntity<List<FullExportResponse>> escapeRoomSessionsGet(String tag) {
