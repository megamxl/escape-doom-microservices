...
public class UserProgress {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.escapeRoomSessionId, userProgress.escapeRoomSessionId) &&
        ...
        Objects.equals(this.score, userProgress.score) &&
        Objects.equals(this.results, userProgress.results);
  }

  @Override
  public int hashCode() {
    return Objects.hash(escapeRoomSessionId, playerName, currentEscapeRoomLevel, lastRiddleSolvedAt, score, results);
  }
