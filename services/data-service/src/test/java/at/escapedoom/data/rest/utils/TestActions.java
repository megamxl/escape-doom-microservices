...
public class TestActions {
    ...
    public void updateLevel(String levelId, String newName, int newSequence) throws Exception {
        LevelDTO requestDto = LevelDTO.builder()
                .levelId(levelId)
                .name(newName)
        ...
        LevelDTO responseDto = LevelDTO.builder()
                .levelId(levelId)
                .name(newName)
                .levelSequence(newSequence)
        ...
        when(levelApiDelegate.updateLevel(levelId, requestDto))
                .thenReturn(ResponseEntity.ok(responseDto));

        mockMvc.perform(put("/v1/levels/{id}", levelId)
    ...
    public void assertLevelUpdated(String levelId, String expectedName, int expectedSequence) throws Exception {
        LevelDTO response = LevelDTO.builder()
                .levelId(levelId)
                .name(expectedName)
                .levelSequence(expectedSequence)
        ...
        mockMvc.perform(get("/v1/levels/{id}", levelId))
                .andExpect(status().isOk())
