...
public interface LevelApi {
    ...
    @Operation(operationId = "createLevel", summary = "Create a new level", description = "Create an EscapeRoomLevel independently of any template", tags = {
            "Level" }, responses = {
                    @ApiResponse(responseCode = "201", description = "Level created successfully", content = {
                            @Content(mediaType = "application/json", schema = @Schema(implementation = EscapeRoomLevelDTO.class)) }),
    ...
    default ResponseEntity<EscapeRoomLevelDTO> getLevel(
     ...
     */
    @Operation(operationId = "updateLevel", summary = "Override a level", description = "Override the details of a EscapeRoomLevel", tags = {
            "Level" }, responses = {
    ...
    default ResponseEntity<EscapeRoomLevelDTO> updateLevel(
            @Parameter(name = "escape-room-level-id", description = "The unique ID of the EscapeRoomLevel", required = true, in = ParameterIn.PATH) @PathVariable("escape-room-level-id") String escapeRoomLevelId,
            @Parameter(name = "EscapeRoomLevelDTO", description = "The overriden details of the EscapeRoomLevel", required = true) @Valid @RequestBody EscapeRoomLevelDTO escapeRoomLevelDTO) {
        return getDelegate().updateLevel(escapeRoomLevelId, escapeRoomLevelDTO);
    }
