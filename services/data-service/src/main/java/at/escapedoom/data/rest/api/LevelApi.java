...
public interface LevelApi {
     ...
     */
    @Operation(
        operationId = "levelEscapeRoomLevelIdDelete",
    ...
    @RequestMapping(
        ...
        value = "/level/{escape-room-level-id}",
        produces = { "application/json" }
    )
     ...
     */
    @Operation(
        operationId = "levelOverideEscapeRoomLevelIdPut",
    ...
    @RequestMapping(
        ...
        value = "/level/overide/{escape-room-level-id}",
        produces = { "application/json" },
     ...
     */
    @Operation(
        operationId = "levelsEscapeRoomLevelIdGet",
        summary = "Get details of a level",
        description = "Retrieve details of a specific EscapeRoomLevel by its ID",
        tags = { "Level" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Level details", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = EscapeRoomLevel.class))
            }),
            @ApiResponse(responseCode = "404", description = "Not Found", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = TemplateDeleteEscapeRoomTemplateIdDelete404Response.class))
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = "/levels/{escape-room-level-id}",
        produces = { "application/json" }
    )
     ...
     */
    @Operation(
        operationId = "levelsEscapeRoomTemplateIdGet",
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = "/levels/{escape-room-template-id}"
    )
